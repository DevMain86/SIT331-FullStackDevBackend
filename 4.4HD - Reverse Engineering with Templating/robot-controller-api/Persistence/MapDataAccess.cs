...
namespace robot_controller_api.Persistence
{
    public static class MapDataAccess
    {
        ...
        private static int GetOrdinalSafe(System.Data.IDataRecord dr, string columnName)
        {
            try
            {
        ...
        public static Map Insert(Map map)
        {
            using var conn = new NpgsqlConnection(CONNECTION_STRING);
            conn.Open();
        ...
        public static bool Update(int id, Map map)
        {
            using var conn = new NpgsqlConnection(CONNECTION_STRING);
            conn.Open();
        ...
        public static bool IsCoordinateOnMap(int id, int x, int y)
        {
